...
|---|---|---|
| [0004 GRPO in two phases](0004-grpo-experiment-plan.md) | Proposed | phase 1 validates the stack on three families against PPO's historical gain; phase 2 branches from the *same BC checkpoint* to test boss. Records predictions in advance, and what neither phase can conclude. |
