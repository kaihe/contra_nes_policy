...
|---|---|---|
| [0011 Ten-hour boss GRPO](0011-boss-grpo.md) | Proposed | finish the graded-reward run that was defunded at update 61: 10 h wall-clock, boss rollout share 1.0, `progress_coef 0.5`. Grading already cut wasted rollout budget 51% → 27%, and boss is the only family where it has leverage (75–79% of rollouts deal damage vs 4–8.5% that succeed). Accepts specialist regression on the other 93%, measured by a full-846 guardrail. Supersedes 0008. |
